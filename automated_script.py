...
def main():
    ...
    try:
        ...
        wurzelBot.check_bee_booster(wurzelBot.note.get_bee_booster())
        ...
        wurzelBot.minigames.play(allowed_events = ['advent_calendar', 'birthday_calendar', 'summer_calendar', 'fair', 'snowball_fight', 'bingo'])
