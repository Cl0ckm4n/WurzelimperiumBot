...
class Http(object):
    ...
    def get_info(self):
        ...
        try:
            ...
            Logger().print_exception('Failed to get birds info')
            return None
    ...
    def start_job(self, jobslot, house_nr):
        ...
        try:
            ...
            Logger().print_exception('Failed to start job')
            return None
    ...
    def feed_bird(self, slot):
        ...
        try:
            ...
            Logger().print_exception('Failed to feed bird')
            return None
    ...
    def remove_job(self, slot):
        ...
        try:
            ...
            Logger().print_exception(f'Failed to remove job in slot {slot}')
            return None
